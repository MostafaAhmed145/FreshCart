...
import ElectronicsCss from "../Electronics/Electronics.module.css"
                            ...
                            <>
                                ...
                                {data.data.data.map((product, inx) => {
                                    ...
                                    {product.category.name == "Electronics" ?  <>
                                        ...
                                        <div key={inx} className={ElectronicsCss.card + " card border p-2 pb-5  text-center relative shadow-lg hover:shadow-2xl  transition-all duration-300 rounded-lg"}>
                                            {product.priceAfterDiscount ? <div className=' absolute top-1 right-1 bg-red-500 text-white rounded-lg z-30 px-3'>Sale </div> : "" }
                                            
                                            <Link to={`/ProductDitelse/${product.id}`} className={ElectronicsCss.link }>
                                                <figure className={`${ElectronicsCss.figre + " "}`}>
                                                    ...
                                                    <figcaption className={`${ElectronicsCss.text} p-2 `} >
                                                    ...
                                                    }} className={ ElectronicsCss.btn + " px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 ease-in-out capitalize w-[75%] z-30  m-auto bottom-1" }>
                                                            Add to cart
                                                    </button>
